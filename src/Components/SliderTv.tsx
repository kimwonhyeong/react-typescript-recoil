...
import {IPopularResult,IMovie,IBestGradeResult,IGetTvResult} from "../api";
...
function SliderTv({tv,id}:sliderProps){
	...
	return(
		<SliderWrapper>
				<ArrowDiv>
					<Arrow xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 448 512" onClick={decreaseIndex}>
				...
				<ArrowDiv>
					<Arrow xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 448 512" onClick={increaseIndex}>
